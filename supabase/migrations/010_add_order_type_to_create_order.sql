...
revoke all on function create_order(text, text, text, numeric, numeric, jsonb, text) from public;
revoke all on function create_order(text, text, text, numeric, numeric, jsonb, text) from anon;
revoke all on function create_order(text, text, text, numeric, numeric, jsonb, text) from authenticated;
grant execute on function create_order(text, text, text, numeric, numeric, jsonb, text) to service_role;
